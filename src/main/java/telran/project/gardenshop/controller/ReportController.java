...
public class ReportController {
        ...
        public ResponseEntity<List<CancelledProductReportDto>> getTopCancelledProducts(
                        @RequestParam(defaultValue = "10") @Parameter(description = "Number of top cancelled products to return", schema = @Schema(minimum = "1", defaultValue = "10")) int limit) {
                List<CancelledProductReportDto> topCancelledProducts = reportService
                                .getTopProductsByCancellations(limit);
