...
public interface SwaggerResponses {
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Grouped profit report retrieved successfully"),
                        @ApiResponse(responseCode = "400", description = "Invalid groupBy parameter. Valid values are: HOUR, DAY, WEEK, MONTH"),
                        @ApiResponse(responseCode = "500", description = "Internal server error")
        })
        @interface GroupedProfitReportRetrieved {
        }
}