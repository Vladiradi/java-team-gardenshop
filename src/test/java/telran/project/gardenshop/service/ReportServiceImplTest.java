...
class ReportServiceImplTest {
        ...
        @Test
        void shouldReturnProfitReport_whenValidDateRangeProvided() {
        ...
        @Test
        void shouldReturnGroupedProfitReport_whenDayGroupingRequested() {
                ...
                assertEquals(BigDecimal.valueOf(40.0).doubleValue(), groupedData.getProfitMargin().doubleValue(),
                                0.001);
        ...
        @Test
        void shouldReturnGroupedProfitReport_whenHourGroupingRequested() {
        ...
        @Test
        void shouldReturnGroupedProfitReport_whenWeekGroupingRequested() {
        ...
        @Test
        void shouldReturnGroupedProfitReport_whenMonthGroupingRequested() {
        ...
        @Test
        void shouldReturnEmptyReport_whenNoOrdersExist() {
                LocalDateTime startDate = LocalDateTime.now().minusDays(7);
                LocalDateTime endDate = LocalDateTime.now();
                GroupByPeriod groupBy = GroupByPeriod.DAY;
        ...
        @Test
        void shouldReturnGroupedProfitReport_whenMultipleOrdersExist() {
                ...
                assertEquals(BigDecimal.valueOf(240).doubleValue(), result.getTotalCost().doubleValue());
                ...
                assertEquals(BigDecimal.valueOf(200), day1Data.getRevenue());
        ...
        @Test
        void shouldReturnTopProductsByType_whenCancellationsReportRequested() {
                ...
                assertEquals(BigDecimal.ZERO, product.getTotalRevenue());
        }

        @Test
        void shouldSortCancellationsByQuantity_whenMultipleCancelledOrdersExist() {
